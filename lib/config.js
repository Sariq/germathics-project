...
const getConfig = () => {
    ...
    if(process.env.NODE_ENV === 'development'){
       // config.databaseConnectionString = 'mongodb://127.0.0.1:27017/germathics';
        config.databaseConnectionString = "mongodb+srv://doadmin:mKiSx4H691057dD2@db-mongodb-nyc1-35482-ff15f9bb.mongo.ondigitalocean.com/germathics?tls=true&authSource=admin&replicaSet=db-mongodb-nyc1-35482";
    }
